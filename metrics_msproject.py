...
def compute_angle_vector(data):
    ...
    # the commented part below includes a filtered version of the body_vector
    # this filtered version was used to improve run time for clustering of the LB_Keough
