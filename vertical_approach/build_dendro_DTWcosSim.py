...
for index_query in range(0, n_videos):
    ...
    for g in range(index_query + 1, n_videos):
        ...
        dtw_sim = dtw_cosSim_vertical(newDF, newDF_query)
...
plt.savefig('Master-Thesis/Dendrograms/DTW_cosSim_dendro_vertical.png', format='png', bbox_inches='tight')
