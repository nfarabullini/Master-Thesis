...
pd.DataFrame(dendro_arr_complete).to_csv("DTW_cosSim_dendro_h_full_filtered_csv")
clustering = AgglomerativeClustering(n_clusters = 9, affinity = 'precomputed', linkage = 'average').fit(dendro_arr_complete)
file1 = open("DTW_cosSim_dendro_h_full_filtered_csv.txt","w")
...
plt.savefig('./Dendrograms/DTW_cosSim_dendro_h_full_filtered.png', format='png', bbox_inches='tight')
