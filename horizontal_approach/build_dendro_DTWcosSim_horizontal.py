from common_funs import compute_df, compute_files_ls, dtw_cosSim_horizontal
...
plt.savefig('Master-Thesis/Dendrograms/DTW_cosSim_dendro_horizontal.png', format='png', bbox_inches='tight')
